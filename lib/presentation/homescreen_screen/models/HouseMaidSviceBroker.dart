...
List<HouseMaidBrokerInfo> brokerInfoFromJson(String str) =>
    List<HouseMaidBrokerInfo>.from(
        json.decode(str).map((x) => HouseMaidBrokerInfo.fromJson(x)));

String brokerInfoToJson(List<HouseMaidBrokerInfo> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class HouseMaidBrokerInfo {
  int? id;
  dynamic googleId;
  String? fullName;
  dynamic email;
  ...
  factory HouseMaidBrokerInfo.fromJson(Map<String, dynamic> json) =>
      HouseMaidBrokerInfo(
        id: json["id"],

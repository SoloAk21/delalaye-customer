...
List<UsedItemBrokerInfo> brokerInfoFromJson(String str) =>
    List<UsedItemBrokerInfo>.from(
        json.decode(str).map((x) => UsedItemBrokerInfo.fromJson(x)));

String brokerInfoToJson(List<UsedItemBrokerInfo> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class UsedItemBrokerInfo {
  int? id;
  dynamic googleId;
  String? fullName;
  dynamic email;
  ...
  factory UsedItemBrokerInfo.fromJson(Map<String, dynamic> json) =>
      UsedItemBrokerInfo(
        id: json["id"],

...
List<CarRentBrokerInfo> brokerInfoFromJson(String str) =>
    List<CarRentBrokerInfo>.from(
        json.decode(str).map((x) => CarRentBrokerInfo.fromJson(x)));

String brokerInfoToJson(List<CarRentBrokerInfo> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CarRentBrokerInfo {
  int? id;
  dynamic googleId;
  String? fullName;
  dynamic email;
  ...
  factory CarRentBrokerInfo.fromJson(Map<String, dynamic> json) =>
      CarRentBrokerInfo(
        id: json["id"],

...
List<CarSaleBrokerInfo> brokerInfoFromJson(String str) =>
    List<CarSaleBrokerInfo>.from(
        json.decode(str).map((x) => CarSaleBrokerInfo.fromJson(x)));

String brokerInfoToJson(List<CarSaleBrokerInfo> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CarSaleBrokerInfo {
  int? id;
  dynamic googleId;
  String? fullName;
  dynamic email;
  ...
  factory CarSaleBrokerInfo.fromJson(Map<String, dynamic> json) =>
      CarSaleBrokerInfo(
        id: json["id"],

...
List<HouseRantBrokerInfo> brokerInfoFromJson(String str) =>
    List<HouseRantBrokerInfo>.from(
        json.decode(str).map((x) => HouseRantBrokerInfo.fromJson(x)));

String brokerInfoToJson(List<HouseRantBrokerInfo> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class HouseRantBrokerInfo {
  int? id;
  dynamic googleId;
  String? fullName;
  dynamic email;
  ...
  factory HouseRantBrokerInfo.fromJson(Map<String, dynamic> json) =>
      HouseRantBrokerInfo(
        id: json["id"],
